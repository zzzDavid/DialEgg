...
define void @printI64Tensor3D(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8) {
  ...
  %19 = call i32 @putchar(i32 91)
  %20 = extractvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %17, 3
  %21 = alloca [3 x i64], i64 1, align 8
  store [3 x i64] %20, ptr %21, align 4
  %22 = getelementptr [3 x i64], ptr %21, i32 0, i32 0
  %23 = load i64, ptr %22, align 4
  %24 = extractvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %17, 3
  %25 = alloca [3 x i64], i64 1, align 8
  store [3 x i64] %24, ptr %25, align 4
  %26 = getelementptr [3 x i64], ptr %25, i32 0, i32 1
  %27 = load i64, ptr %26, align 4
  %28 = extractvalue { ptr, ptr, i64, [3 x i64], [3 x i64] } %17, 3
  %29 = alloca [3 x i64], i64 1, align 8
  store [3 x i64] %28, ptr %29, align 4
  %30 = getelementptr [3 x i64], ptr %29, i32 0, i32 2
...
35:                                               ; preds = %32
  call void @printNewline()
  %36 = call i32 @putchar(i32 9)
  %37 = call i32 @putchar(i32 91)
  %38 = insertvalue { ptr, ptr, i64 } undef, ptr %0, 0
  %39 = insertvalue { ptr, ptr, i64 } %38, ptr %1, 1
  %40 = insertvalue { ptr, ptr, i64 } %39, i64 0, 2
  %41 = mul i64 %33, %6
  %42 = add i64 %2, %41
  %43 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } undef, ptr %0, 0
  %44 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %43, ptr %1, 1
  %45 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %44, i64 %42, 2
  %46 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %45, i64 %27, 3, 0
  %47 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %46, i64 %7, 4, 0
  %48 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %47, i64 %31, 3, 1
  %49 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %48, i64 %8, 4, 1
  %50 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %49, 0
  %51 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %49, 1
  %52 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %49, 2
  %53 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %49, 3, 0
  %54 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %49, 3, 1
  %55 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %49, 4, 0
  %56 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %49, 4, 1
  call void @printI64Tensor2D(ptr %50, ptr %51, i64 %52, i64 %53, i64 %54, i64 %55, i64 %56)
  %57 = call i32 @putchar(i32 93)
  %58 = sub i64 %23, 1
