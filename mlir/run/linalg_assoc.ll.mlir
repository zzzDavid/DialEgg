module {
  ...
  llvm.func @main() -> f32 {
    ...
    %36 = llvm.mlir.constant(150 : index) : i64
    %37 = llvm.mlir.constant(1 : index) : i64
    %38 = llvm.mlir.constant(1500 : index) : i64
    %39 = llvm.mlir.zero : !llvm.ptr
    %40 = llvm.getelementptr %39[1500] : (!llvm.ptr) -> !llvm.ptr, i64
    ...
    %69 = llvm.mlir.constant(150 : index) : i64
    %70 = llvm.mlir.constant(8 : index) : i64
    %71 = llvm.mlir.constant(1 : index) : i64
    %72 = llvm.mlir.constant(1200 : index) : i64
    %73 = llvm.mlir.zero : !llvm.ptr
    %74 = llvm.getelementptr %73[1200] : (!llvm.ptr) -> !llvm.ptr, i64
