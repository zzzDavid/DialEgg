module {
  ...
  llvm.func @printI64Tensor3D(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: i64, %arg8: i64) {
    ...
    %14 = llvm.mlir.constant(91 : i32) : i32
    %15 = llvm.mlir.constant(93 : i32) : i32
    %16 = llvm.call @putchar(%14) : (i32) -> i32
    %17 = llvm.mlir.constant(1 : index) : i64
    %18 = llvm.extractvalue %8[3] : !llvm.struct<(ptr, ptr, i64, array<3 x i64>, array<3 x i64>)> 
    %19 = llvm.alloca %17 x !llvm.array<3 x i64> : (i64) -> !llvm.ptr
    llvm.store %18, %19 : !llvm.array<3 x i64>, !llvm.ptr
    %20 = llvm.getelementptr %19[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<3 x i64>
    %21 = llvm.load %20 : !llvm.ptr -> i64
    %22 = llvm.mlir.constant(1 : index) : i64
    %23 = llvm.extractvalue %8[3] : !llvm.struct<(ptr, ptr, i64, array<3 x i64>, array<3 x i64>)> 
    %24 = llvm.alloca %22 x !llvm.array<3 x i64> : (i64) -> !llvm.ptr
    llvm.store %23, %24 : !llvm.array<3 x i64>, !llvm.ptr
    %25 = llvm.getelementptr %24[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<3 x i64>
    %26 = llvm.load %25 : !llvm.ptr -> i64
    %27 = llvm.mlir.constant(1 : index) : i64
    %28 = llvm.extractvalue %8[3] : !llvm.struct<(ptr, ptr, i64, array<3 x i64>, array<3 x i64>)> 
    %29 = llvm.alloca %27 x !llvm.array<3 x i64> : (i64) -> !llvm.ptr
    llvm.store %28, %29 : !llvm.array<3 x i64>, !llvm.ptr
    %30 = llvm.getelementptr %29[0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<3 x i64>
    %31 = llvm.load %30 : !llvm.ptr -> i64
    llvm.br ^bb1(%11 : i64)
  ^bb1(%32: i64):  // 2 preds: ^bb0, ^bb4
    %33 = llvm.icmp "slt" %32, %21 : i64
    llvm.cond_br %33, ^bb2, ^bb5
  ^bb2:  // pred: ^bb1
    llvm.call @printNewline() : () -> ()
    %34 = llvm.call @putchar(%10) : (i32) -> i32
    %35 = llvm.call @putchar(%14) : (i32) -> i32
    %36 = llvm.mlir.undef : !llvm.struct<(ptr, ptr, i64)>
    %37 = llvm.insertvalue %arg0, %36[0] : !llvm.struct<(ptr, ptr, i64)> 
    %38 = llvm.insertvalue %arg1, %37[1] : !llvm.struct<(ptr, ptr, i64)> 
    %39 = llvm.mlir.constant(0 : index) : i64
    %40 = llvm.insertvalue %39, %38[2] : !llvm.struct<(ptr, ptr, i64)> 
    %41 = llvm.mul %32, %arg6  : i64
    %42 = llvm.add %arg2, %41  : i64
    %43 = llvm.mlir.undef : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
    %44 = llvm.insertvalue %arg0, %43[0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %45 = llvm.insertvalue %arg1, %44[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %46 = llvm.insertvalue %42, %45[2] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %47 = llvm.insertvalue %26, %46[3, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %48 = llvm.insertvalue %arg7, %47[4, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %49 = llvm.insertvalue %31, %48[3, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %50 = llvm.insertvalue %arg8, %49[4, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    ...
    llvm.call @printI64Tensor2D(%51, %52, %53, %54, %55, %56, %57) : (!llvm.ptr, !llvm.ptr, i64, i64, i64, i64, i64) -> ()
    %58 = llvm.call @putchar(%15) : (i32) -> i32
    %59 = llvm.sub %21, %12  : i64
    %60 = llvm.icmp "ult" %32, %59 : i64
    llvm.cond_br %60, ^bb3, ^bb4
  ^bb3:  // pred: ^bb2
    llvm.call @printComma() : () -> ()
    llvm.br ^bb4
  ^bb4:  // 2 preds: ^bb2, ^bb3
    %61 = llvm.add %32, %12  : i64
    llvm.br ^bb1(%61 : i64)
  ^bb5:  // pred: ^bb1
    %62 = llvm.icmp "sgt" %21, %11 : i64
    llvm.cond_br %62, ^bb6, ^bb7
  ^bb6:  // pred: ^bb5
    llvm.call @printNewline() : () -> ()
    llvm.br ^bb7
  ^bb7:  // 2 preds: ^bb5, ^bb6
    %63 = llvm.call @putchar(%15) : (i32) -> i32
    llvm.return
  }
  ...
  llvm.func @displayTime(%arg0: i64, %arg1: i64) {
    %0 = llvm.mlir.constant(62 : i32) : i32
    %1 = llvm.mlir.constant(45 : i32) : i32
    %2 = llvm.mlir.constant(32 : i32) : i32
    %3 = llvm.mlir.constant(115 : i32) : i32
    %4 = llvm.mlir.constant(117 : i32) : i32
    %5 = llvm.mlir.constant(1.000000e+06 : f64) : f64
    %6 = llvm.sub %arg1, %arg0  : i64
    %7 = llvm.uitofp %6 : i64 to f64
    %8 = llvm.fdiv %7, %5  : f64
    llvm.call @printF64(%7) : (f64) -> ()
    %9 = llvm.call @putchar(%2) : (i32) -> i32
    %10 = llvm.call @putchar(%4) : (i32) -> i32
    %11 = llvm.call @putchar(%3) : (i32) -> i32
    %12 = llvm.call @putchar(%2) : (i32) -> i32
    %13 = llvm.call @putchar(%1) : (i32) -> i32
    %14 = llvm.call @putchar(%0) : (i32) -> i32
    %15 = llvm.call @putchar(%2) : (i32) -> i32
    llvm.call @printF64(%8) : (f64) -> ()
    %16 = llvm.call @putchar(%2) : (i32) -> i32
    %17 = llvm.call @putchar(%3) : (i32) -> i32
    llvm.return
  }
}
