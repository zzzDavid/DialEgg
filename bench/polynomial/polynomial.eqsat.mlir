module {
  ...
  func.func @fillRandomF64Tensor2D(%arg0: tensor<?x?xf64>) -> tensor<?x?xf64> {
    ...
    %0 = linalg.fill_rng_2d ins(%cst, %cst_0, %c0_i32 : f64, f64, i32) outs(%arg0 : tensor<?x?xf64>) -> tensor<?x?xf64>
    return %0 : tensor<?x?xf64>
  }
  func.func @main() -> i32 {
    %c1000000 = arith.constant 1000000 : index
    %c4 = arith.constant 4 : index
    %0 = tensor.empty(%c1000000, %c4) : tensor<?x?xf64>
    %1 = call @fillRandomF64Tensor2D(%0) : (tensor<?x?xf64>) -> tensor<?x?xf64>
    %cast = tensor.cast %1 : tensor<?x?xf64> to tensor<1000000x4xf64>
    %2 = call @clock() : () -> i64
    ...
    %4 = scf.for %arg0 = %c0 to %c1000000 step %c1 iter_args(%arg1 = %3) -> (tensor<1000000xf64>) {
      %extracted = tensor.extract %cast[%arg0, %c0] : tensor<1000000x4xf64>
      %extracted_1 = tensor.extract %cast[%arg0, %c1] : tensor<1000000x4xf64>
      %extracted_2 = tensor.extract %cast[%arg0, %c2] : tensor<1000000x4xf64>
      %extracted_3 = tensor.extract %cast[%arg0, %c3] : tensor<1000000x4xf64>
