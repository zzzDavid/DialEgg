module {
  ...
  llvm.func @poly_eval_4(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: f64, %arg4: f64, %arg5: f64) -> f64 {
    %0 = llvm.fmul %arg0, %arg5  : f64
    %1 = llvm.fadd %arg1, %0  : f64
    %2 = llvm.fmul %arg5, %1  : f64
    %3 = llvm.fadd %2, %arg2  : f64
    %4 = llvm.fmul %arg5, %3  : f64
    %5 = llvm.fadd %arg3, %4  : f64
    %6 = llvm.fmul %arg5, %5  : f64
    %7 = llvm.fadd %arg4, %6  : f64
    llvm.return %7 : f64
  }
}
