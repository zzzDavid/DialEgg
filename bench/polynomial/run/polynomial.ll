...
define i32 @main() {
  %1 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (double, ptr null, i64 5000000) to i64), i64 64))
...
define double @poly_eval_4(double %0, double %1, double %2, double %3, double %4, double %5) {
  %7 = call double @llvm.pow.f64(double %5, double 2.000000e+00)
  %8 = call double @llvm.pow.f64(double %5, double 3.000000e+00)
  %9 = call double @llvm.pow.f64(double %5, double 4.000000e+00)
  %10 = fmul double %3, %5
  %11 = fmul double %2, %7
  %12 = fmul double %1, %8
  %13 = fmul double %0, %9
