; ModuleID = 'bench/polynomial/run/polynomial.canon.ll'
...
52:                                               ; preds = %fillRandomF64Tensor2D.exit, %52
  ...
  %65 = fmul double %62, 5.000000e+00
  %66 = fmul double %60, 2.500000e+01
  %67 = fmul double %58, 1.250000e+02
  %68 = fmul double %56, 6.250000e+02
...
define double @poly_eval_4(double %0, double %1, double %2, double %3, double %4, double %5) local_unnamed_addr #2 {
  %square = fmul double %5, %5
  %7 = tail call double @llvm.pow.f64(double %5, double 3.000000e+00)
  %8 = tail call double @llvm.pow.f64(double %5, double 4.000000e+00)
  %9 = fmul double %3, %5
  %10 = fmul double %square, %2
  %11 = fmul double %7, %1
  %12 = fmul double %8, %0
