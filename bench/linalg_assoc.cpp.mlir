module {
  ...
  func.func @main() -> i32 {
    ...
    %4 = tensor.empty() : tensor<10x8xi64>
    %5 = linalg.matmul ins(%2, %3 : tensor<10x150xi64>, tensor<150x8xi64>) outs(%4 : tensor<10x8xi64>) -> tensor<10x8xi64>
    %6 = tensor.empty() : tensor<100x8xi64>
    %7 = linalg.matmul ins(%1, %5 : tensor<100x10xi64>, tensor<10x8xi64>) outs(%6 : tensor<100x8xi64>) -> tensor<100x8xi64>
    %8 = call @clock() : () -> i64
