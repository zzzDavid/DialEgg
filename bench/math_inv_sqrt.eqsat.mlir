module {
  ...
  func.func @fillRandomF64Tensor2D(%arg0: tensor<100000x3xf64>) -> tensor<100000x3xf64> {
    ...
    %0 = linalg.fill_rng_2d ins(%cst, %cst_0, %c0_i32 : f64, f64, i32) outs(%arg0 : tensor<100000x3xf64>) -> tensor<100000x3xf64>
  ...
  func.func @main() -> i32 {
    ...
    %5 = call @clock() : () -> i64
    %6 = call @normalize_distance_vectors(%2) : (tensor<100000x3xf32>) -> tensor<100000x3xf32>
    %7 = call @blackhole(%6) : (tensor<100000x3xf32>) -> tensor<100000x3xf32>
