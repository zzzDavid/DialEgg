...
func.func @fillRandomF64Tensor2D(%tensor: tensor<100000x4xf64>) -> tensor<100000x4xf64> {
    ...
    %tensor_filled = linalg.fill_rng_2d ins(%min, %max, %seed : f64, f64, i32) 
                                        outs(%tensor : tensor<100000x4xf64>) -> tensor<100000x4xf64>

    return %tensor_filled : tensor<100000x4xf64>
}
...
func.func @main() -> i32 {
    ...
    %poly_eval_cast = tensor.cast %poly_eval : tensor<100000xf64> to tensor<?xf64>
