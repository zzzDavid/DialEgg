...
define i32 @main() {
  %1 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i64 35000) to i64), i64 64))
  ...
  %14 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i64 43750) to i64), i64 64))
  ...
  %27 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i64 37500) to i64), i64 64))
  %28 = ptrtoint ptr %27 to i64
  %29 = add i64 %28, 63
  %30 = urem i64 %29, 64
  %31 = sub i64 %29, %30
  ...
  %39 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %38, i64 1, 4, 1
  %40 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i64 1500) to i64), i64 64))
...
define { ptr, ptr, i64, [2 x i64], [2 x i64] } @_3mm(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, i64 %12, i64 %13, ptr %14, ptr %15, i64 %16, i64 %17, i64 %18, i64 %19, i64 %20, ptr %21, ptr %22, i64 %23, i64 %24, i64 %25, i64 %26, i64 %27) {
  ...
  %57 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i32 50000) to i64), i64 64))
  ...
  %66 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %65, i64 200, 3, 0
  %67 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %66, i64 250, 3, 1
  %68 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %67, i64 250, 4, 0
  %69 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %68, i64 1, 4, 1
  br label %70

70:                                               ; preds = %106, %28
  %71 = phi i64 [ %107, %106 ], [ 0, %28 ]
  %72 = icmp slt i64 %71, 200
...
81:                                               ; preds = %78
  ...
  %88 = getelementptr i64, ptr %8, i64 %9
  %89 = mul i64 %79, %12
  %90 = mul i64 %75, %13
  %91 = add i64 %89, %90
...
108:                                              ; preds = %70
  %109 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i32 30000) to i64), i64 64))
  ...
  %118 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %117, i64 200, 3, 0
  %119 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %118, i64 150, 3, 1
  %120 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %119, i64 150, 4, 0
  %121 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %120, i64 1, 4, 1
  br label %122

122:                                              ; preds = %156, %108
  %123 = phi i64 [ %157, %156 ], [ 0, %108 ]
  %124 = icmp slt i64 %123, 200
...
133:                                              ; preds = %130
  %134 = mul i64 %123, 250
  %135 = add i64 %134, %131
  %136 = getelementptr i64, ptr %62, i64 %135
  %137 = load i64, ptr %136, align 4
  %138 = getelementptr i64, ptr %15, i64 %16
  %139 = mul i64 %131, %19
  %140 = mul i64 %127, %20
  %141 = add i64 %139, %140
...
180:                                              ; preds = %183, %179
  ...
  %182 = icmp slt i64 %181, 150
  br i1 %182, label %183, label %204

183:                                              ; preds = %180
  %184 = mul i64 %173, 150
  %185 = add i64 %184, %181
  %186 = getelementptr i64, ptr %114, i64 %185
  %187 = load i64, ptr %186, align 4
  %188 = getelementptr i64, ptr %22, i64 %23
  %189 = mul i64 %181, %26
  %190 = mul i64 %177, %27
  %191 = add i64 %189, %190
  %192 = getelementptr i64, ptr %188, i64 %191
