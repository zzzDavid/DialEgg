module {
  ...
  llvm.func @_3mm(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: !llvm.ptr, %arg8: !llvm.ptr, %arg9: i64, %arg10: i64, %arg11: i64, %arg12: i64, %arg13: i64, %arg14: !llvm.ptr, %arg15: !llvm.ptr, %arg16: i64, %arg17: i64, %arg18: i64, %arg19: i64, %arg20: i64, %arg21: !llvm.ptr, %arg22: !llvm.ptr, %arg23: i64, %arg24: i64, %arg25: i64, %arg26: i64, %arg27: i64) -> !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> {
    ...
    %37 = llvm.mlir.constant(175 : index) : i64
    %38 = llvm.mlir.constant(0 : index) : i64
    %39 = llvm.mlir.constant(175 : index) : i64
    %40 = llvm.mlir.constant(150 : index) : i64
    %41 = llvm.mlir.constant(1 : index) : i64
    %42 = llvm.mlir.constant(26250 : index) : i64
    %43 = llvm.mlir.zero : !llvm.ptr
    %44 = llvm.getelementptr %43[26250] : (!llvm.ptr) -> !llvm.ptr, i64
  ...
  ^bb6:  // pred: ^bb5
    %71 = llvm.getelementptr %arg8[%arg9] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %72 = llvm.mul %65, %arg12  : i64
    %73 = llvm.mul %69, %arg13  : i64
    %74 = llvm.add %72, %73  : i64
    %75 = llvm.getelementptr %71[%74] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %76 = llvm.load %75 : !llvm.ptr -> i64
    %77 = llvm.getelementptr %arg15[%arg16] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %78 = llvm.mul %69, %arg19  : i64
    %79 = llvm.mul %67, %arg20  : i64
    %80 = llvm.add %78, %79  : i64
    %81 = llvm.getelementptr %77[%80] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %82 = llvm.load %81 : !llvm.ptr -> i64
    %83 = llvm.mlir.constant(150 : index) : i64
    ...
    %89 = llvm.add %87, %88  : i64
    %90 = llvm.mlir.constant(150 : index) : i64
  ...
  ^bb15:  // pred: ^bb14
    %129 = llvm.mlir.constant(150 : index) : i64
    ...
    %134 = llvm.getelementptr %arg22[%arg23] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %135 = llvm.mul %127, %arg26  : i64
    %136 = llvm.mul %125, %arg27  : i64
