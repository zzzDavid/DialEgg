...
define i32 @main() {
  ...
  %54 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i32 50000) to i64), i64 64))
  ...
  %64 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %63, i64 250, 3, 1
  %65 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %64, i64 250, 4, 0
  %66 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %65, i64 1, 4, 1
  br label %67

67:                                               ; preds = %99, %0
  %68 = phi i64 [ %100, %99 ], [ 0, %0 ]
  %69 = icmp slt i64 %68, 200
...
75:                                               ; preds = %78, %74
  ...
  %77 = icmp slt i64 %76, 175
  br i1 %77, label %78, label %97

78:                                               ; preds = %75
  %79 = mul i64 %68, 175
  %80 = add i64 %79, %76
  %81 = getelementptr i64, ptr %7, i64 %80
  %82 = load i64, ptr %81, align 4
  %83 = mul i64 %76, 250
  %84 = add i64 %83, %72
  %85 = getelementptr i64, ptr %20, i64 %84
...
101:                                              ; preds = %67
  %102 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i32 30000) to i64), i64 64))
  ...
  %111 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %110, i64 200, 3, 0
  %112 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %111, i64 150, 3, 1
  %113 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %112, i64 150, 4, 0
  %114 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %113, i64 1, 4, 1
  br label %115

115:                                              ; preds = %147, %101
  %116 = phi i64 [ %148, %147 ], [ 0, %101 ]
  %117 = icmp slt i64 %116, 200
...
126:                                              ; preds = %123
  ...
  %131 = mul i64 %124, 150
  %132 = add i64 %131, %120
  %133 = getelementptr i64, ptr %33, i64 %132
...
171:                                              ; preds = %174, %170
  ...
  %173 = icmp slt i64 %172, 150
  br i1 %173, label %174, label %193

174:                                              ; preds = %171
  %175 = mul i64 %164, 150
  %176 = add i64 %175, %172
  %177 = getelementptr i64, ptr %107, i64 %176
  %178 = load i64, ptr %177, align 4
  %179 = mul i64 %172, 10
  %180 = add i64 %179, %168
  %181 = getelementptr i64, ptr %46, i64 %180
