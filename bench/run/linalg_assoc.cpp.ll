...
define i32 @main() {
  ...
  %41 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i32 80) to i64), i64 64))
  ...
  %50 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %49, i64 10, 3, 0
...
62:                                               ; preds = %65, %61
  ...
  %64 = icmp slt i64 %63, 150
  br i1 %64, label %65, label %84

65:                                               ; preds = %62
  %66 = mul i64 %55, 150
  %67 = add i64 %66, %63
  %68 = getelementptr i64, ptr %20, i64 %67
  %69 = load i64, ptr %68, align 4
  %70 = mul i64 %63, 8
  %71 = add i64 %70, %59
  %72 = getelementptr i64, ptr %33, i64 %71
...
113:                                              ; preds = %110
  ...
  %118 = mul i64 %111, 8
  %119 = add i64 %118, %107
  %120 = getelementptr i64, ptr %46, i64 %119
