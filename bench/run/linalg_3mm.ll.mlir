module {
  ...
  llvm.func @main() -> i32 {
    ...
    %5 = llvm.mlir.constant(200 : index) : i64
    ...
    %114 = llvm.mlir.constant(250 : index) : i64
    %115 = llvm.mlir.constant(1 : index) : i64
    %116 = llvm.mlir.constant(50000 : index) : i64
    %117 = llvm.mlir.zero : !llvm.ptr
    %118 = llvm.getelementptr %117[50000] : (!llvm.ptr) -> !llvm.ptr, i64
  ...
  ^bb6:  // pred: ^bb5
    %145 = llvm.mlir.constant(175 : index) : i64
    %146 = llvm.mul %139, %145  : i64
    %147 = llvm.add %146, %143  : i64
    %148 = llvm.getelementptr %25[%147] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %149 = llvm.load %148 : !llvm.ptr -> i64
    %150 = llvm.mlir.constant(250 : index) : i64
    %151 = llvm.mul %143, %150  : i64
    %152 = llvm.add %151, %141  : i64
    %153 = llvm.getelementptr %51[%152] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %154 = llvm.load %153 : !llvm.ptr -> i64
    %155 = llvm.mlir.constant(250 : index) : i64
    ...
    %162 = llvm.mlir.constant(250 : index) : i64
  ...
  ^bb8:  // pred: ^bb3
    ...
    llvm.br ^bb1(%168 : i64)
  ^bb9:  // pred: ^bb1
    %169 = llvm.mlir.constant(200 : index) : i64
    %170 = llvm.mlir.constant(150 : index) : i64
    %171 = llvm.mlir.constant(1 : index) : i64
    %172 = llvm.mlir.constant(30000 : index) : i64
    %173 = llvm.mlir.zero : !llvm.ptr
    %174 = llvm.getelementptr %173[30000] : (!llvm.ptr) -> !llvm.ptr, i64
  ...
  ^bb15:  // pred: ^bb14
    %201 = llvm.mlir.constant(250 : index) : i64
    ...
    %206 = llvm.mlir.constant(150 : index) : i64
    %207 = llvm.mul %199, %206  : i64
    %208 = llvm.add %207, %197  : i64
    %209 = llvm.getelementptr %77[%208] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %210 = llvm.load %209 : !llvm.ptr -> i64
    %211 = llvm.mlir.constant(150 : index) : i64
    ...
    %218 = llvm.mlir.constant(150 : index) : i64
