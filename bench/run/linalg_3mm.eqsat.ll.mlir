module {
  ...
  llvm.func @main() -> i32 {
    ...
    %113 = llvm.mlir.constant(250 : index) : i64
    %114 = llvm.mlir.constant(10 : index) : i64
    %115 = llvm.mlir.constant(1 : index) : i64
    %116 = llvm.mlir.constant(2500 : index) : i64
    %117 = llvm.mlir.zero : !llvm.ptr
    %118 = llvm.getelementptr %117[2500] : (!llvm.ptr) -> !llvm.ptr, i64
  ...
  ^bb6:  // pred: ^bb5
    %145 = llvm.mlir.constant(150 : index) : i64
    %146 = llvm.mul %139, %145  : i64
    %147 = llvm.add %146, %143  : i64
    %148 = llvm.getelementptr %77[%147] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %149 = llvm.load %148 : !llvm.ptr -> i64
    %150 = llvm.mlir.constant(10 : index) : i64
    %151 = llvm.mul %143, %150  : i64
    %152 = llvm.add %151, %141  : i64
    %153 = llvm.getelementptr %103[%152] : (!llvm.ptr, i64) -> !llvm.ptr, i64
