module {
  ...
  llvm.func @poly_eval_3(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: f64, %arg4: f64) -> f64 {
    %0 = llvm.fmul %arg0, %arg4  {fastmathFlags = #llvm.fastmath<fast>} : f64
    %1 = llvm.fadd %arg1, %0  {fastmathFlags = #llvm.fastmath<fast>} : f64
    %2 = llvm.fmul %1, %arg4  {fastmathFlags = #llvm.fastmath<fast>} : f64
    %3 = llvm.fadd %2, %arg2  {fastmathFlags = #llvm.fastmath<fast>} : f64
  ...
  llvm.func @poly_eval_2(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: f64) -> f64 {
    %0 = llvm.fmul %arg0, %arg3  {fastmathFlags = #llvm.fastmath<fast>} : f64
    %1 = llvm.fadd %0, %arg1  {fastmathFlags = #llvm.fastmath<fast>} : f64
    %2 = llvm.fmul %arg3, %1  {fastmathFlags = #llvm.fastmath<fast>} : f64
