...
define i32 @main() {
  ...
  %54 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (i64, ptr null, i32 2500) to i64), i64 64))
  ...
  %63 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %62, i64 250, 3, 0
...
78:                                               ; preds = %75
  %79 = mul i64 %68, 150
  %80 = add i64 %79, %76
  %81 = getelementptr i64, ptr %33, i64 %80
  %82 = load i64, ptr %81, align 4
  %83 = mul i64 %76, 10
  %84 = add i64 %83, %72
  %85 = getelementptr i64, ptr %46, i64 %84
...
126:                                              ; preds = %123
  %127 = mul i64 %116, 250
  %128 = add i64 %127, %124
  %129 = getelementptr i64, ptr %20, i64 %128
  %130 = load i64, ptr %129, align 4
  %131 = mul i64 %124, 10
  %132 = add i64 %131, %120
  %133 = getelementptr i64, ptr %59, i64 %132
