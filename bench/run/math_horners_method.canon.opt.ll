; ModuleID = 'bench/run/math_horners_method.canon.ll'
...
define double @poly_eval_3(double %0, double %1, double %2, double %3, double %4) local_unnamed_addr #3 {
  %6 = tail call fast double @llvm.powi.f64.i32(double %4, i32 3)
  %7 = fmul fast double %4, %1
  %8 = fmul fast double %6, %0
  %reass.add = fadd fast double %7, %2
  %reass.mul = fmul fast double %reass.add, %4
  %9 = fadd fast double %8, %3
  %10 = fadd fast double %9, %reass.mul
  ret double %10
}
...
define double @poly_eval_2(double %0, double %1, double %2, double %3) local_unnamed_addr #3 {
  ...
  %reass.add = fadd fast double %5, %1
  %reass.mul = fmul fast double %reass.add, %3
  %6 = fadd fast double %reass.mul, %2
  ret double %6
}
