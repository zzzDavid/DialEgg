...
define { float, float, float } @normalize_vector(float %0, float %1, float %2) {
  ...
  %7 = fadd float %4, %5
  %8 = fadd float %7, %6
  %9 = call float @fast_inv_sqrt(float %8)
  %10 = fmul float %0, %9
  %11 = fmul float %1, %9
  %12 = fmul float %2, %9
  %13 = insertvalue { float, float, float } undef, float %10, 0
  %14 = insertvalue { float, float, float } %13, float %11, 1
...
60:                                               ; preds = %35
  ...
  %70 = call i64 @clock()
  %71 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %34, 0
  %72 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %34, 1
  %73 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %34, 2
  %74 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %34, 3, 0
  %75 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %34, 3, 1
  %76 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %34, 4, 0
  %77 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %34, 4, 1
  %78 = call { ptr, ptr, i64, [2 x i64], [2 x i64] } @normalize_distance_vectors(ptr %71, ptr %72, i64 %73, i64 %74, i64 %75, i64 %76, i64 %77)
  %79 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %78, 0
  %80 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %78, 1
  %81 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %78, 2
  %82 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %78, 3, 0
  %83 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %78, 3, 1
  %84 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %78, 4, 0
  %85 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %78, 4, 1
  %86 = call { ptr, ptr, i64, [2 x i64], [2 x i64] } @blackhole(ptr %79, ptr %80, i64 %81, i64 %82, i64 %83, i64 %84, i64 %85)
