...
define double @poly_eval_3(double %0, double %1, double %2, double %3, double %4) {
  %6 = call fast double @llvm.pow.f64(double %4, double 2.000000e+00)
  %7 = call fast double @llvm.pow.f64(double %4, double 3.000000e+00)
  %8 = fmul fast double %2, %4
  %9 = fmul fast double %1, %6
  %10 = fmul fast double %0, %7
  %11 = fadd fast double %9, %10
  %12 = fadd fast double %8, %11
  %13 = fadd fast double %3, %12
  ret double %13
}

define double @poly_eval_2(double %0, double %1, double %2, double %3) {
  %5 = call fast double @llvm.pow.f64(double %3, double 2.000000e+00)
  %6 = fmul fast double %1, %3
  %7 = fmul fast double %0, %5
...
define i32 @main() {
  %1 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (double, ptr null, i32 400000) to i64), i64 64))
  ...
  %22 = call i64 @clock()
  %23 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (double, ptr null, i32 100000) to i64), i64 64))
  ...
  %32 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %31, i64 100000, 3, 0
