module {
  ...
  func.func @main() -> i32 {
    ...
    %0 = tensor.empty(%c1000000, %c3) : tensor<?x?xf64>
    %1 = call @fillRandomF64Tensor2D(%0) : (tensor<?x?xf64>) -> tensor<?x?xf64>
    %2 = arith.truncf %1 : tensor<?x?xf64> to tensor<?x?xf32>
    %cast = tensor.cast %2 : tensor<?x?xf32> to tensor<1000000x3xf32>
    %3 = call @clock() : () -> i64
    %4 = call @normalize_distance_vectors(%cast) : (tensor<1000000x3xf32>) -> tensor<1000000x3xf32>
    %5 = call @clock() : () -> i64
    %cast_0 = tensor.cast %4 : tensor<1000000x3xf32> to tensor<?x?xf32>
    call @printF32Tensor2D(%cast_0) : (tensor<?x?xf32>) -> ()
    call @printNewline() : () -> ()
