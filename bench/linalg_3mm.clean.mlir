module {
  ...
  func.func @main() -> i32 {
    ...
    %6 = linalg.matmul ins(%1, %2 : tensor<200x175xi64>, tensor<175x250xi64>) outs(%5 : tensor<200x250xi64>) -> tensor<200x250xi64>
    %7 = tensor.empty() : tensor<200x150xi64>
    %8 = linalg.matmul ins(%6, %3 : tensor<200x250xi64>, tensor<250x150xi64>) outs(%7 : tensor<200x150xi64>) -> tensor<200x150xi64>
    %9 = tensor.empty() : tensor<200x10xi64>
    %10 = linalg.matmul ins(%8, %4 : tensor<200x150xi64>, tensor<150x10xi64>) outs(%9 : tensor<200x10xi64>) -> tensor<200x10xi64>
    %11 = call @clock() : () -> i64
