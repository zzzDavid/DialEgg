module {
  ...
  func.func @poly_eval_3(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: f64, %arg4: f64) -> f64 {
    %0 = arith.mulf %arg0, %arg4 fastmath<fast> : f64
    %1 = arith.addf %arg1, %0 fastmath<fast> : f64
    %2 = arith.mulf %1, %arg4 fastmath<fast> : f64
    %3 = arith.addf %2, %arg2 fastmath<fast> : f64
  ...
  func.func @poly_eval_2(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: f64) -> f64 {
    %0 = arith.mulf %arg0, %arg3 fastmath<fast> : f64
    %1 = arith.addf %0, %arg1 fastmath<fast> : f64
