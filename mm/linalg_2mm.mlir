module {
  ...
  func.func @main() -> i32 {
    ...
    %3 = tensor.empty() : tensor<100x100xi32>
    %4 = linalg.matmul ins(%0, %1 : tensor<100x100xi32>, tensor<100x100xi32>) outs(%3 : tensor<100x100xi32>) -> tensor<100x100xi32>
    %5 = tensor.empty() : tensor<100x100xi32>
    %6 = linalg.matmul ins(%4, %2 : tensor<100x100xi32>, tensor<100x100xi32>) outs(%5 : tensor<100x100xi32>) -> tensor<100x100xi32>
